...
This week I fixed a lot of little things. Feedback to the user, throttling, resposiveness etc.. I also fixed some bigger things. The app will now get the fleets and vehicles from the user's view access instead of all from the company.

Joeri Malmberg made a service that aggregates live vehicle data of multiple vehicles. This was needed in the live data blocks for the user's company and fleets. This was a major improvement.

I spend a lot of time managing the alpha release and fixing stuff that I did wrong the week before. We now got a solid Alpha, Beta and Production pipeline to release updates to the app to.

I finished the week with compiling the iOS version of the app. This all worked. It is identical to the Android version with the exception of things like the navigation bar which are in the os's style.

### For who/what did I do this?

I did all of this to prepare for the Beta release to customers. I needed to sort all of this out and I did.

### What went well/not so well?

Everthing went really well.
